...
public class FingerprintAuthAux {
        ...
        if (action.equals(SAVE)) {
            ...
            if (isFingerprintAuthAvailable()) {
                ...
                if (setUserAuthenticationRequired) {
                    ...
                    SharedPreferences sharedPref = cordova.getActivity().getApplicationContext().getSharedPreferences(
            ...
            SharedPreferences oldSharedPref = cordova.getActivity().getApplicationContext().getSharedPreferences(
                oldActivityPackageName, Context.MODE_PRIVATE);
            String enc = oldSharedPref.getString("fing" + key, "");

            if (!enc.equals("")) {
                SharedPreferences newSharedPref = cordova.getActivity().getApplicationContext().getSharedPreferences(
                    SHARED_PREFS_NAME, Context.MODE_PRIVATE);
    ...
    private boolean hasEnrolledFingerprints() {
        if (mParentCordovaPlugin == null || mParentCordovaPlugin.cordova.getActivity()
